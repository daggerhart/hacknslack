...
var globalActions = {
  ...
  status: function( Game, done ){
    ...
    Game.output( 'XP: ' + c.xp );
    Game.output( 'HP: ' + c.attributes.hp );
    Game.output( 'Body: ' + c.attributes.body + ' / ' + c.getAttrTotal('body') );
    Game.output( 'Mind: ' + c.attributes.mind + ' / ' + c.getAttrTotal('mind') );
    Game.output( 'Spirit: ' + c.attributes.spirit + ' / ' + c.getAttrTotal('spirit') );

    Game.output('Inventory');
    Game.output( 'Current Adventure: ' + Game.adventure.name );
