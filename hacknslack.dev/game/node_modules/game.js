...
var Game = function( req ) {
  ...
  this.nextEncounter = function(){
    ...
    //console.log('next encounter index = ' + next);
    //console.log('adventure encounters');
    //console.log(this.adventure.encounters);
  ...
  this.generateAdventure = function(){
    ...
    var adventure 
      = new Adventure(adventures[tools.random(0,adventures.length-1)]);
    this.debug("***TRYING TO BE ON ADVENTURE: " + adventure.title);
    adventure.encounters = this.generateEncounters(adventure);
  ...
  this.generateEncounters = function(adventure){
    ...
    all_encounters.forEach( function(possible_encounter) {
      console.log("***We are on adventure: "+adventure.title);
      adventure.tags.forEach( function(tag) {
        if(possible_encounter.tags.indexOf(tag) != -1) {
