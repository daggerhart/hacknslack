...
var globalActions = {
  ...
  status: function( Game, done ){
    ...
    Game.output( c.name );
    Game.output( 'Class: ' + c.class );
    Game.output( 'HP: ' + c.attributes.hp );
    Game.output( 'Body: ' + c.attributes.body );
    Game.output( 'Mind: ' + c.attributes.mind );
    Game.output( 'Spirit: ' + c.attributes.spirit );
