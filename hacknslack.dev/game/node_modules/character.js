/**
 * A "character" object is a saved state of a player's current in-game persona
 *
...
Character.prototype = {
  ...
  levelUp: function ( Game ) {
    this.xp = 0;
    this.level++;
    Game.output("You have reached a new level of skill!");
    Game.output("You are now a level "+this.level+" "+this.class.name+"!");
